...
namespace mpm_web_api.DAL.andon
{
    public class ErrorOnsiteService: SqlSugarBase
    {
        ...
        public bool MaterialRequestTrigger()
        {
            return false;
        }
        ...
        public bool MaterialRequestRelease()
        {
            return false;
        }
            ...
            if(el != null)
            {
                ...
                if(ps != null)
                {
                    ...
                    if(el.substitutes != "")
                    {
                        ...
                        {
                            return DB.Updateable<error_log>().UpdateColumns(it => new error_log() { arrival_time = DateTime.Now }).ExecuteCommand() > 0;
