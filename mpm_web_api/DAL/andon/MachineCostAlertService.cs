...
{
    public class MachineCostAlertService : SqlSugarBase
    {
        public List<machine_cost_alert_detail> QueryableDetailToList()
        {
            List<machine_cost_alert_detail> list = DB.Queryable<machine_cost_alert_detail>()
                                .Mapper((it) =>
                                {
