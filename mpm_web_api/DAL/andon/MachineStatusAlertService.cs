...
{
    public class MachineStatusAlertService: SqlSugarBase
    {
        public List<machine_status_alert_detail> QueryableDetailToList()
        {
            List<machine_status_alert_detail> list = DB.Queryable<machine_status_alert_detail>()
                                .Mapper((it) =>
                                {
