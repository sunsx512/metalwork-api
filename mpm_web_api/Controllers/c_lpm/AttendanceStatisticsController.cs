...
namespace mpm_web_api.Controllers.c_lpm
{
    ...
    public class AttendanceStatisticsController : Controller
    {
        ...
        /// <response code="411">外键异常</response>
        [HttpGet]
        public ActionResult<common.response<attendance_statistics>> Get()
        {
            return Json(ch.Get());
        }
        ...
        /// <response code="411">外键异常</response>
        [HttpPost]
        public ActionResult<common.response> Post(attendance_statistics t)
        {
        ...
        /// <response code="411">外键异常</response>
        [HttpPut]
        public ActionResult<common.response> Put(attendance_statistics t)
        {
