...
namespace mpm_web_api.Controllers.c_andon
{
    ...
    public class MachineFaultAlertController : SSOController
    {
        ...
        /// <response code="411">外键异常</response>
        [HttpGet]
        public ActionResult<common.response<machine_fault_alert>> Get()
        {
            return Json(ch.Get());
        }
        ...
        /// <response code="411">外键异常</response>
        [HttpPost]
        public ActionResult<common.response> Post(machine_fault_alert t)
        {
        ...
        /// <response code="411">外键异常</response>
        [HttpPut]
        public ActionResult<common.response> Put(machine_fault_alert t)
        {
