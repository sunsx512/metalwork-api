...
(
    "id" serial NOT NULL,
    "migration_version" varchar(2000) COLLATE "pg_catalog"."default" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "common"."tag_type_sub_custom" (
  ...
  "name_tw" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "description" varchar(255) COLLATE "pg_catalog"."default" ,
  CONSTRAINT "tag_type_sub_custom_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "common"."tag_type_sub_fixed" (
  ...
  "name_tw" varchar(255) COLLATE "pg_catalog"."default" NOT NULL,
  "description" varchar(255) COLLATE "pg_catalog"."default" ,
  CONSTRAINT "tag_type_sub_fixed_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE IF NOT EXISTS "oee"."status_setting" (
  "id" serial NOT NULL,
  "status_name" varchar(100) COLLATE "pg_catalog"."default" NOT NULL,
  "value" int4 NOT NULL,
...
INSERT INTO "common"."tag_type_sub_fixed" VALUES (19, 4, '平衡率预警', 'work_order_balancing_rate_alert', '平衡率預警', '平衡率预警');
